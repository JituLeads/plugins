<style>
/* Style for Phone button functionality for JituLeads Product Chat plugin.
 ...
 */
            ...
            .marketing_telp {
                padding: 8px;
                gap: 15px;
                background: linear-gradient(135deg, #257fd3, #145396); /* WhatsApp-like gradient */
                color: #fff;
                overflow: hidden;
                height: 70px;
                border-radius: 60px;
            ...
            .marketing_telp:before {
                ...
                height: 100%;
                background: rgba(59, 137, 255, 0.8); /* Flash color with transparency */
