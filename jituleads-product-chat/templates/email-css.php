<style>
 /* Style for Email button functionality for JituLeads Product Chat plugin.
 ...
 */
            ...
            .marketing_email {
                padding: 8px;
                gap: 15px;
                background: linear-gradient(135deg, #d32525, #961414); /* WhatsApp-like gradient */
                color: #fff;
                overflow: hidden;
                height: 70px;
                border-radius: 60px;
            ...
            .marketing_email:before {
                ...
                height: 100%;
                background: rgba(255, 59, 59, 0.8); /* Flash color with transparency */
